...
const officeHighlights = [
  'Office relocation in Orlando',
  'Desks, chairs, and workstations',
  'Packing and moving support',
  'Loading and unloading service',
  'Organized scheduling',
  'Fast quotes and flexible timing',
];

const officeBenefits = [
  {
    title: 'Planned office relocation',
    text: 'We help businesses stay organized with practical planning, clear communication, and careful handling during office moves.',
  },
  {
    title: 'Furniture and equipment handling',
    text: 'Desks, chairs, office furniture, boxes, and general business items are moved with attention and care.',
  },
  {
    title: 'Flexible scheduling',
    text: 'We work with your timing to help reduce disruption and keep your office move as smooth as possible.',
  },
];
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <h1 className="mb-5 max-w-3xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
                Office Movers in Orlando, FL You Can Trust
              </h1>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl backdrop-blur-md sm:p-8">
              ...
              <h2 className="mb-4 text-2xl font-bold text-white">
                Office Moves Need Clear Organization
              </h2>

              <p className="mb-6 leading-relaxed text-white/80">
                Business moves often require scheduling, coordination, and
                careful handling of workspaces, furniture, and office items. We
                help keep that process simple and manageable.
              </p>
        ...
        <div className="mx-auto max-w-6xl">
          <header className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <h2 className="mb-4 text-3xl font-bold text-gray-900 sm:text-4xl">
              Professional Office Moving Services in Orlando
            </h2>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1fr_0.9fr]">
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-100 sm:p-8">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                Office relocation usually needs more coordination than a regular
                move because timing, layout, and business continuity matter.
              </p>
              <p>
                Our team helps businesses move furniture, workstations, boxes,
                and office items in a more organized way, with practical support
            ...
            <div className="mt-8 rounded-2xl border border-blue-400/20 bg-blue-500/10 p-5">
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-white/80">
                  Trusted office moving support
                </span>
              </div>

              <h3 className="mb-2 text-lg font-semibold">
                Need a smoother office relocation?
              </h3>
              <p className="mb-4 leading-relaxed text-white/75">
                We help businesses move with practical planning, organized
                service, and careful handling across Orlando.
              </p>
