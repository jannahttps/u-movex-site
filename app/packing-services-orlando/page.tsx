...
export const metadata: Metadata = {
  title: 'Packing Services Orlando, FL | UMOVEX Moving Company',
  description:
    'Need packing services in Orlando, FL? UMOVEX helps with professional packing, wrapping, moving boxes, fragile item protection, loading, and careful moving support across Orlando and Central Florida.',
  alternates: {
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p className="mb-6 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
                Looking for reliable packing services in Orlando? UMOVEX helps
        ...
        <div className="mx-auto max-w-6xl">
          <header className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              ...
              a full move, UMOVEX provides organized packing support designed to
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1fr_0.9fr]">
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-100 sm:p-8">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <p>
                If you are comparing packing services in Orlando, UMOVEX offers
