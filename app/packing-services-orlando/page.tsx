...
export const metadata: Metadata = {
  title: 'Packing Services Orlando, FL | U-MOVEX Moving Company',
  description:
    'Need packing services in Orlando, FL? U-MOVEX helps with professional packing, wrapping, moving boxes, fragile item protection, loading, and careful moving support across Orlando and Central Florida.',
  alternates: {
    canonical: '/packing-services-orlando',
  },
};
...
const packingBenefits = [
  {
    title: 'Careful packing for fragile items',
    text: 'We help protect glass, dishes, decor, electronics, and other delicate belongings with practical packing and wrapping.',
  },
  {
    title: 'Organized moving preparation',
    text: 'Packing before moving day helps keep the relocation process cleaner, faster, and easier to manage.',
  },
  {
    title: 'Support for homes, apartments, and offices',
    text: 'Whether you need partial packing or more complete moving help, we can support different types of moves across Orlando.',
  },
];
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              <p className="mb-3 inline-flex rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-blue-100 backdrop-blur-sm sm:text-sm">
                U-MOVEX Packing Services
              </p>

              <h1 className="mb-5 max-w-3xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
                Packing Services in Orlando, FL You Can Trust
              </h1>

              <p className="mb-6 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
                Looking for reliable packing services in Orlando? U-MOVEX helps
                with moving boxes, wrapping, fragile item protection, furniture
                padding, loading, and organized moving support across Central Florida.
              </p>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl backdrop-blur-md sm:p-8">
              ...
              <p className="mb-6 leading-relaxed text-white/80">
                A lot of moving stress starts before the truck even arrives.
                Good packing helps protect your belongings, reduce chaos, and
                make moving day feel more organized.
              </p>
        ...
        <div className="mx-auto max-w-6xl">
          <header className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <h2 className="mb-4 text-3xl font-bold text-gray-900 sm:text-4xl">
              Professional Packing Services in Orlando
            </h2>
            <p className="text-lg leading-relaxed text-gray-600">
              Whether you need help packing a few fragile items or preparing for
              a full move, U-MOVEX provides organized packing support designed to
              protect your belongings and simplify the moving process.
            </p>
          </header>

          <div className="grid gap-8 md:grid-cols-3">
            {packingBenefits.map((item, index) => (
              <article
                key={item.title}
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1fr_0.9fr]">
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-100 sm:p-8">
            ...
            <h2 className="mb-5 text-3xl font-bold text-gray-900 sm:text-4xl">
              Why Clients Choose Our Packing Services in Orlando
            </h2>

            <div className="space-y-4 text-gray-600">
              <p>
                Packing takes time, attention, and the right approach. Rushing it
                often leads to broken items, messy boxes, and a more stressful move.
              </p>
              <p>
                Our team helps organize belongings, protect fragile items, and
                prepare boxes and furniture in a way that makes transportation safer
                and unpacking easier.
              </p>
              <p>
                If you are comparing packing services in Orlando, U-MOVEX offers
                practical help that supports both the moving process and the people
                going through it.
              </p>
            </div>
            ...
            <div className="mt-8 rounded-2xl border border-blue-100 bg-blue-50 p-5">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                Need packing help before your move?
              </h3>
              <p className="mb-4 leading-relaxed text-gray-600">
                Call us or request an estimate online to get started with packing
                services in Orlando.
              </p>
              <div className="flex flex-col gap-3 sm:flex-row">
                <a
            ...
            <div className="mt-8 rounded-2xl border border-blue-400/20 bg-blue-500/10 p-5">
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-white/80">
                  Trusted packing support
                </span>
              </div>

              <h3 className="mb-2 text-lg font-semibold">
                Want a more organized move?
              </h3>
              <p className="mb-4 leading-relaxed text-white/75">
                We help with wrapping, packing, box organization, and careful
                preparation across Orlando.
              </p>
