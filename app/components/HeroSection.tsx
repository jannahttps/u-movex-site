        ...
        <div className="flex flex-col items-center sm:items-end gap-2">
          <div className="flex flex-col sm:flex-row sm:items-center text-white font-bold text-lg sm:text-2xl">
            ...
            <a
              ...
              className="hover:underline mt-1 sm:mt-0 text-base sm:text-2xl font-semibold"
            >
              umovexfl@gmail.com
            </a>
          </div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
              aria-label="WhatsApp"
            >
